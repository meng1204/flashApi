...
class FlashPayDataBase{
    ...
    getNonceStr(){
        ...
        //     if(this.queryValues[i]['nonce_str'] !='undefined'){
        //         //console.log("datad//// getnoncestr  " +this.queryValues[i]['nonce_str'])
        //         return this.queryValues[i]['nonce_str'];
        //     } 
        // }
    }
    ...
    setTime(value){
        ...
        // this.queryValues.push({'time':value});
    ...
    getTime(){
        ...
        // for(var i in this.queryValues){
        //     if(this.queryValues[i]['time'] !='undefined'){
        //         return this.queryValues[i]['time'];
        //     }
        // }
    ...
    setSign(){
        ...
        //this.queryValues.push({'sign':sign});
        return sign;
    }
     ...
     **/
     getSign(){
        ...
        // for(var i in this.queryValues){
        //     if(this.queryValues[i]['sign'] !='undefined'){
        //         return this.queryValues[i]['sign'];
        //     }
        // }
    ...
    toQueryParams(){
        ...
        // for (var i in this.queryValues){
        //     var values = Object.key(queryValues[i]);
        //     values.forEach(function(value){
        //         console.log(value + "=" + queryValues[i][value] );
        //         buff += value + "=" + this.queryValues[i][value] + "&";;
        //     });
        // }
        // buff = buff.slice(0,-1);
